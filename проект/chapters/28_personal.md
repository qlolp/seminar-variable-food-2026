...
**Что из этого следует.** Доп. нагрузка модели М1 — около 40 минут в сутки на отделение 30 жителей (≈ 80 человеко-минут в неделю). Это укладывается в пересменку, если минуты видны в планировании. М2–М3 дают +60–90 минут в сутки; М4 и М5 перестраивают роль персонала целиком. Для группы помощи добавочное время выше: 2–3 мин/житель. Возражение «нас не хватит» чаще закрывается потоком (раздел 20): предзаказ, визуальное меню, маркировка «вариант А / вариант Б».
...
**Цифра для учредителя.** +22 минуты на обед для 30 жителей в модели М1. Показать рабочей группе и решить: укладываем в пересменку или выходим с заявкой на ставку. Решение «мы не справимся, потому что страшно» без цифры — не управление.
