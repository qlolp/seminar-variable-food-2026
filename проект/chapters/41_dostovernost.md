...
**Российские практики.** Каждая упомянутая практика имеет публичный первоисточник с датой публикации{{S015}}{{S016}}{{S017}}{{S018}}{{S019}}. Оценка распространённости практик («мало», «растёт») помечена как интерпретация, основанная на открытом поиске, а не на репрезентативном обследовании — такого обследования не существует.
