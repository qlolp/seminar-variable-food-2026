...
**Российская статистика.** Числа о системе ПНИ (количество организаций, жителей, доля недееспособных) взяты из вторичной аналитики («Если быть точным» / ТАСС, апрель 2026){{S016}} и везде в тексте помечены как вторичные данные, а не официальная статотчётность. Где данные не удалось подтвердить независимо, это сказано прямо.

**Российские практики.** Каждая упомянутая практика имеет публичный первоисточник с датой публикации{{S018}}{{S019}}{{S020}}{{S021}}. Оценка распространённости практик («мало», «растёт») помечена как интерпретация, основанная на открытом поиске, а не на репрезентативном обследовании — такого обследования не существует.
