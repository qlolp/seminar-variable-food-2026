...
**Вывод 1. Еда в вашем учреждении — юридически значимая зона, а не бытовая.** Проживающие в ПНИ и ДСО для лиц с психическими расстройствами пользуются правами пациентов психиатрических стационаров (ст. 43 Закона № 3185-1), а питание прямо нормировано СанПиН 2.3/2.4.3590-20 (не менее трёх приёмов в день, диетическое по показаниям){{S011}}{{S003}}. Ошибки за столом — предмет прокурорских проверок и дел по ст. 6.6 КоАП{{S012}}. Разделы 17, 32, 33.

**Вывод 2. Выбор блюд законен — и это уже делают в России.** Ни одна федеральная норма не запрещает вариативность; таблицы замены продуктов в раскладках — законный механизм эквивалентной замены{{S008}}{{S021}}. В 2024–2025 годах минимум три учреждения (два ПНИ Новосибирской области, ДСО Иркутской области) публично внедрили вариативное меню; в Иркутской области практика масштабируется на регион{{S015}}{{S016}}{{S017}}{{S018}}. Разделы 8, 23, 25.
...
**Вывод 10. Пилот за 90 дней реалистичен без новых денег.** Схема: месяц измерений → месяц документов и обучения → месяц пилота на одном типовом отделении с выбором из двух вариантов на завтрак и обед (модель, подтверждённая российской практикой){{S015}}{{S016}}. Раздел 35.
