...
Вариативность не создаёт новых санитарных требований — она удваивает точки применения существующих. Если контур (пробы, температуры, маркировка, журналы) работает фактически, второй вариант проходит его без проблем; если контур имитируется, вариативность удвоит имитацию и риск. Поэтому санитарная готовность — обязательный фундамент дорожной карты (раздел 35): сначала контур, потом выбор. Это не «модель М0» лестницы вариативности: М0 в разделе 8.2 — мономеню с учётом отказов, а не санитарный минимум.
