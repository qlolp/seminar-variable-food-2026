...
Второй вариант проходит тот же санитарный контур: пробы, температуры, маркировка, журналы. Если контур имитируется, вариативность удвоит имитацию. Сначала контур (модель М0), потом выбор.
