...
Санитарные правила для организаций социального обслуживания (СанПиН 2.3/2.4.3590-20) требуют: не менее трёх приёмов пищи в день, диетическое питание по показаниям, контроль на всех этапах — приёмка сырья, суточные пробы готовой продукции, бракераж, температурный режим, питьевой режим{{S003}}. Ни один пункт этих правил не ограничивает число вариантов блюда. Вариативность попадает в санитарный контур целиком — и в этом её сила (каждый вариант защищён теми же процедурами, что и мономеню), и её уязвимость (каждый вариант должен их проходить).
