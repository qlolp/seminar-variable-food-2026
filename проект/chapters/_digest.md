...
Скрининг статуса питания **MUST** — пять минут силами медсестры, приоритет и план действий по риску. Шкала текстур **IDDSI** — терминология и проверка консистенции, не диагноз: текстуру назначает врач. Рост соответствия 44→90 % — пять учреждений общего long-term care (Wu 2022), **не психиатрия**; прямой перенос на ПНИ не доказан. Немецкая модель **Wunschkost** («еда по желанию») — стандарт паллиатива и критических состояний в DGE/Австрии, **не российская норма и не ежедневное меню ДСО**. Nijs 2006 (семейная подача) — голландские дома ухода **без деменции**; на контингент ПНИ не переносится. Ориентиры, не требования проверяющих.
