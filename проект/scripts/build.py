...
# приложения
parts.append('''\n# Часть III. Приложения: проекты локальных форм (36 шаблонов)

Тридцать шесть шаблонов — рабочий инструментарий доклада: чек-листы, формы, журналы, алгоритмы, проекты приказов и положений. Каждый шаблон снабжён дисклеймером: это проект локальной формы, не нормативно установленный документ; он требует адаптации под региональное законодательство, учётную политику, структуру учреждения, медицинскую лицензию и требования учредителя. Порядок внедрения комплекта — раздел 36 и конец части III.''')
