...
**Основания.** IDDSI — международный стандарт описания текстур{{M-iddsi2017}}; внедрение стандарта улучшает соответствие назначенной текстуры фактической{{M-iddsi_wu}}; исполнение врачебного назначения — обязанность, вытекающая из п. 7.1.12 СанПиН (питание по заключению врача для нуждающихся){{S005}}.
...
**Основания.** Права жителя не ограничиваются по требованию третьих лиц без оснований (ст. 37, 43 закона 3185-1){{S003}}; участие близких в пищевой биографии приветствуется как источник информации, но не как источник запретов (раздел 15).
...
**Основания.** Набор веса на антипсихотиках — документированный дозозависимый эффект{{M-pillinger}}{{M-fepwg}}; гиперфагия и ночное едение описаны как специфические синдромы{{M-resolve}}; обязанность исполнять назначение — из п. 7.1.12 СанПиН{{S005}}.
