...
**Основания.** IDDSI — международный стандарт описания текстур{{M-iddsi2017}}; внедрение стандарта улучшает соответствие назначенной текстуры фактической{{M-iddsi_wu}}; исполнение врачебного назначения — обязанность, вытекающая из п. 7.1.12 СанПиН 3590-20 (с 01.09.2026 — п. 56 подп. 11 4282-26: питание по медицинским показаниям){{S003}}.
...
**Основания.** Набор веса на антипсихотиках — документированный дозозависимый эффект{{M-pillinger}}{{M-fepwg}}; гиперфагия и ночное едение описаны как специфические синдромы{{M-resolve}}; обязанность исполнять назначение — из п. 7.1.12 СанПиН 3590-20 (с 01.09.2026 — п. 56 подп. 11 4282-26){{S003}}.
