...
**Основания.** Недопустимость принудительного кормления — из ст. 37 закона 3185-1 (гуманное обращение){{S003}}; риск недоедания при отказах — клиническая проблема с документированной летальной значимостью (пневмония, истощение){{M-dysph_prev}}{{M-mortality}}.
...
**Основания.** Режим питания СОСО по СанПиН — не реже трёхразового с учётом заключения врача для нуждающихся (п. 7.1.11–7.1.14){{S005}}; седация как побочный эффект и её влияние на режим — клиническая реальность антипсихотической терапии{{M-metmon}}. Международный ориентир гибкости: «что, когда, где и как я ем» (Стандарт 6){{I-aus6}}.
...
**Основания.** Пищевая агрессия и гиперфагия — описанные паттерны поведения при психических расстройствах{{M-resolve}}{{M-ebt}}; обязанность защищать жителя от вредного воздействия других жителей — из общей логики ст. 37{{S003}}.
