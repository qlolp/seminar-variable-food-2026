...
**Основания.** СанПиН задаёт кратность (не реже трёхразового) и учёт заключения врача, а не астрономическое время ужина{{S005}}; право на привычный ритм — элемент уважения биографии (ст. 37){{S003}}.
...
**Основания.** Норма 1:2 при кормлении под «готовые руки» — онтарийский стандарт, используемый здесь как ориентир, а не как российский норматив{{I-ontario}}; обязанность обеспечить потребление назначенного питания — из ст. 37/43 и СанПиН{{S003}}{{S005}}.
...
**Основания.** Ст. 37/43 закона 3185-1 — права не ставятся в зависимость от дееспособности{{S003}}; КПИ и общие замечания ККИ — о поддерживаемом принятии решений{{I-crpd28}}{{I-gc1}}; международные нормы прямо требуют учёта предпочтений при когнитивных ограничениях{{I-aus6}}{{I-ontario}}.
