...
# 01 Титул
add(slide(1,
    kick('Методические рекомендации · опыт реализации проектов') +
    h('Организация<br>вариативного питания', 56, top=112, weight=900) +
    bar(52, 258, 52, 3) +
    tx('в домах социального обслуживания', 52, 280, 856, size=22, italic=True, serif=True, weight=600, color=MID) +
    tx('<b style="font-weight:600">Чистяков Евгений Владимирович</b><br>'
       'директор СПб ГАСУСОН «ДСО „Серафимовский“»', 52, 396, 856, size=16, color=INK, lh=1.4)))
