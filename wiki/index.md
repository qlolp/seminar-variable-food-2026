...
- [[wiki/concepts/variativnost]] — [Вариативность](concepts/variativnost.md) — два варианта в момент еды; не цикл и не таблица замен
- [[wiki/concepts/lestnica-modelej]] — [Модели М0–М5](concepts/lestnica-modelej.md) — технология раздачи; российский старт М1–М2
- [[wiki/concepts/lestnica-uchastiya]] — [Ступени участия](concepts/lestnica-uchastiya.md) — другая ось 0–5; не склеивать с моделями
- [[wiki/concepts/pary-ekvivalentov]] — [Пары эквивалентов](concepts/pary-ekvivalentov.md) — второй вариант без второй кухни
- [[wiki/concepts/fiktivnaya-variativnost]] — [Фиктивная вариативность](concepts/fiktivnaya-variativnost.md) — положение есть, вчерашнего выбора нет
- [[wiki/concepts/pravo-na-vybor]] — [Право на выбор](concepts/pravo-na-vybor.md) — запрета нет, ежедневного права на два вторых тоже нет
- [[wiki/concepts/komplekt-proveryayushchemu]] — [Комплект проверяющему](concepts/komplekt-proveryayushchemu.md) — папка, не формула
- [[wiki/concepts/disfagiya]] — [Дисфагия](concepts/disfagiya.md) — выбор внутри текстуры; кухня не назначает
- [[wiki/concepts/lekarstva-i-eda]] — [Лекарства и еда](concepts/lekarstva-i-eda.md) — пять правил таблицы врача
- [[wiki/concepts/tri-otkaza]] — [Три отказа](concepts/tri-otkaza.md) — три подряд → врач сегодня
- [[wiki/concepts/chetyre-kanala-voli]] — [Четыре канала воли](concepts/chetyre-kanala-voli.md) — показ, тарелка, биография, близкие
- [[wiki/concepts/pilot-90]] — [Пилот 90 дней](concepts/pilot-90.md) — одно отделение; исполнимость, не РКИ
